...
# CC Compiler Flags
CCFLAGS=-pg -DMPICH_IGNORE_CXX_SEEK -llapack -lblas -larmadillo
CXXFLAGS=-pg -DMPICH_IGNORE_CXX_SEEK -llapack -lblas -larmadillo
...
${OBJECTDIR}/Lanczos.o: Lanczos.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/Lanczos.o Lanczos.cpp

${OBJECTDIR}/HamiltonMatrix.o: HamiltonMatrix.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/HamiltonMatrix.o HamiltonMatrix.cpp

${OBJECTDIR}/ImportSlater.o: ImportSlater.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/ImportSlater.o ImportSlater.cpp
