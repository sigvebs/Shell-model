...
${OBJECTDIR}/Lanczos.o: Lanczos.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/Lanczos.o Lanczos.cpp

${OBJECTDIR}/HamiltonMatrix.o: HamiltonMatrix.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/HamiltonMatrix.o HamiltonMatrix.cpp

${OBJECTDIR}/ImportSlater.o: ImportSlater.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/ImportSlater.o ImportSlater.cpp
